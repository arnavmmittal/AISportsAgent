  ...
  try {
    ...
    if (authError) {
      if (authError.message.includes('already registered')) {
        ...
        const existingUser = users.find(u => u.email === 'test@athlete.com');
  ...
  try {
    ...
    if (existingUsers.length > 0) {
      ...
      await pgClient.query(`
        INSERT INTO "User" (id, email, name, role, "emailVerified", "schoolId", "createdAt", "updatedAt")
        VALUES ($1, $2, $3, $4, $5, $6, NOW(), NOW())
      `, [userId, 'test@athlete.com', 'Test Athlete', 'ATHLETE', new Date(), schoolId]);
