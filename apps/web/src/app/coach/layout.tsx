...
export default function CoachLayout({
  ...
  const navItems = COACH_NAV.filter((item) => item.href !== '/coach/settings');
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="hidden md:flex min-h-screen">
        ...
        {/* Content Area (no top bar — title + profile float in page space) */}
        <div className="flex-1 ml-[72px] relative">
          ...
          {/* Page Content — full area, no wrapper bar */}
