  ...
  return (
    <div className="border border-border rounded-lg bg-card shadow-sm">
      ...
      {signals.riskPenalty > 0 && (
        <div className="border-t border-border bg-muted-foreground/10 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <svg className="w-5 h-5 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <span className="text-sm font-semibold text-muted-foreground">Risk Flags Detected</span>
            </div>
            <span className="text-sm font-bold text-muted-foreground">-{signals.riskPenalty} pts</span>
          </div>
        </div>
      )}
