 ...
 *
 * Purpose: "Deep dive on INDIVIDUALS"
 * - View and manage your roster
 * - Risk-prioritized athlete listing
 * - Quick access to individual profiles
 *
 * This is now the canonical roster page. /coach/team redirects here.
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <header className="animate-fade-in">
          ...
          <p className="text-muted-foreground mt-1">
            Your roster with risk-prioritized insights
          </p>
        </header>
