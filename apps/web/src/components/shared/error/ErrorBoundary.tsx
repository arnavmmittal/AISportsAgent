...
function DefaultErrorFallback({ error, resetError }: DefaultErrorFallbackProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[200px] p-6 bg-destructive/10 rounded-lg border border-destructive">
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="px-4 py-2 bg-muted text-muted-foreground rounded-md hover:bg-muted/50 transition-colors"
        >
          Reload page
        </button>
      </div>
